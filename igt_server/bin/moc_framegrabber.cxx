...
const QMetaObject FrameGrabber::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_FrameGrabber,
      qt_meta_data_FrameGrabber, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FrameGrabber::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FrameGrabber))
        return static_cast<void*>(const_cast< FrameGrabber*>(this));
...
// SIGNAL 0
void FrameGrabber::frameReady(IplImage * _t1)
{
